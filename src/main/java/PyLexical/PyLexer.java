...
public class PyLexer extends Lexer {
	...
	public static final int
		...
		COLONEQUAL=59, COMMENT=60, ANNOTATION=61;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"RARROW", "ELLIPSIS", "COLONEQUAL", "COMMENT", "ANNOTATION", "LETTER", 
			"DECIMAL_DIGIT", "OCT_DIGIT", "HEX_DIGIT"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"AT", "ATEQUAL", "RARROW", "ELLIPSIS", "COLONEQUAL", "COMMENT", "ANNOTATION"
		};
	}
